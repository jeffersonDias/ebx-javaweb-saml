            ...
            <div class="section">
                <div class="section-content">
                    <div class="post">
                        ...
                        <p class="quiet large">Please login to the metadata administration using a local account.</p>
                        <div class="post-body">
                            ...
                            <form name='loginForm' action="<c:url value='/saml/web/login' />" method="post">
                                <table>
                                    <tr>
                                        ...
                                        <td><input type='text' name='j_username' id="username" class="text" /></td>
                                    </tr>
                                    <tr>
                                        <td><label for="password">Password:</label></td>
                                        <td><input type='password' name='j_password' id="password" class="text" /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
